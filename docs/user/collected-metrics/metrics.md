...
| glean.usage.foreground_count |[counter](https://mozilla.github.io/glean/book/user/metrics/counter.html) |A counter, incremented every time the app is brought to foreground. Mobile only.  |[1](https://bugzilla.mozilla.org/show_bug.cgi?id=1683707#c2)||never |1 |
